...
import {IDistributionV6} from "../interfaces/capital-protocol/IDistributionV6.sol";

import {LogExpMath} from "../libs/LogExpMath.sol";
import {ReferrerLib} from "../libs/ReferrerLib.sol";

contract DistributionV6 is IDistributionV6, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function _claimReferrerTier(uint256 poolId_, address referrer_, address receiver_) private {
        uint256 currentPoolRate_ = _getCurrentPoolRate(poolId_);
