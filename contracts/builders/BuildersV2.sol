...
import {IBuildersV2, IERC165} from "../interfaces/builders/IBuildersV2.sol";
...
contract BuildersV2 is IBuildersV2, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function supportsInterface(bytes4 interfaceId_) external pure returns (bool) {
        return interfaceId_ == type(IBuildersV2).interfaceId || interfaceId_ == type(IERC165).interfaceId;
    }
